...
<html>
	 ...
	 $(function () { 
		 ...
		 $("#delBot").click(function(){
			 ...
			 $("input[name='checkOne']").each(function(i,n){
				 ...
				 location.href="del.do?ids="+ids.join(",");
			 });
		 });
	 });
  ...
  <body>
     ...
     <a href="getAllCount.do"><button style="width:100px;height:30px;margin-left:96px;font-size: 12px;margin-top:10px;">返回</button></a>
     <button id="delBot"  style="width:100px;height:30px;margin-left:10px;font-size: 12px;">删除选定项</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button value="" type="button" class="btn btn-default" data-dismiss="modal">关闭
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
